  ...
  setup() {
    ...
    ================================================*/
      ...
      (function () {
        ...
        g.Group.prototype.each = function (action, ascs) {
          let asc = ascs || 0,
            i;
          if (asc) {
    ...
    ================================================*/
      ...
      (function () {
        ...
        g.SnakeTile.prototype.render = function () {
          this.elem.style.left = this.x + "px";
          this.elem.style.top = this.y + "px";
          this.elem.style.width = this.w + "px";
          this.elem.style.height = this.h + "px";
    ...
    ================================================*/
      ...
      (function () {
        ...
        StatePlay.prototype.keydown = function (el) {
          el.preventDefault();
          let e = el.keyCode ? el.keyCode : el.which,
